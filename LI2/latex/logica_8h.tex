...
Definido na linha 101 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{101                              \{}
\DoxyCodeLine{102     \textcolor{keywordtype}{int} col = e-\/>ultima\_jogada.coluna, lin = e-\/>ultima\_jogada.linha;}
\DoxyCodeLine{103     \textcolor{keywordflow}{if} (\mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin, col + 1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin+1, col+1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin+1, col) == PRETA \&\&}
\DoxyCodeLine{104     \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin, col-\/1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin-\/1, col-\/1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin-\/1, col) == PRETA)}
...
\DoxyCodeLine{93     \}}
\DoxyCodeLine{95     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (\mbox{\hyperlink{logica_8h_a9065d2c25c9052ce1f7f5e1d6272dd6e}{check\_around}}(e) == 1)}
...
Definido na linha 203 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{203                                 \{}
\DoxyCodeLine{204     \textcolor{keywordtype}{char} *end;}
\DoxyCodeLine{205     \textcolor{keywordtype}{int} col, lin;}
\DoxyCodeLine{206     lin = strtol(str, \&end,  10);}
\DoxyCodeLine{207     col = strtol(end,  \&end,10);}
\DoxyCodeLine{208     \mbox{\hyperlink{struct_c_o_o_r_d_e_n_a_d_a}{COORDENADA}} cord = \{col, abs(lin-\/7)\};}
\DoxyCodeLine{209     \textcolor{keywordflow}{return} cord;}
\DoxyCodeLine{210 \}}
...
Definido na linha 320 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{320                      \{}
\DoxyCodeLine{321     \mbox{\hyperlink{structnodo}{LISTA}} L = \mbox{\hyperlink{lista_8h_ae3b99323b6f8f35d80bb69ff1a27985e}{criar\_lista}}();}
\DoxyCodeLine{322     L = \mbox{\hyperlink{lista_8h_a0b56764e73eb24ca541210236e5ee307}{add\_livres}}(e, L);}
\DoxyCodeLine{323     \mbox{\hyperlink{structnodo}{LISTA}} T = L;}
\DoxyCodeLine{324     \textcolor{keywordtype}{int} length = lengthLista(L);}
\DoxyCodeLine{325     \textcolor{keywordtype}{int} random = rand() \% length;}
\DoxyCodeLine{326     \textcolor{keywordtype}{char} *str;}
\DoxyCodeLine{327     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < random; i++)}
\DoxyCodeLine{328         T = \mbox{\hyperlink{lista_8h_ad9380152361127432c55c1c6067e05ae}{proximo}}(T);}
\DoxyCodeLine{329     str = (\textcolor{keywordtype}{char}*) \mbox{\hyperlink{lista_8h_abfcb205f3eb670157be0d1221021714b}{devolve\_cabeca}}(T);}
\DoxyCodeLine{330     \mbox{\hyperlink{struct_c_o_o_r_d_e_n_a_d_a}{COORDENADA}} \mbox{\hyperlink{logica_8h_a9dfbc982d23a619e36575d8e7ec8e41c}{jog}} = \mbox{\hyperlink{logica_8h_a33c8928e31992541dd9cf0ce0e9f7d50}{get\_cords}}(str);}
\DoxyCodeLine{331     \mbox{\hyperlink{logica_8h_ac313d7e553b1e2b5f266acb9bfff8141}{jogar}}(e, \mbox{\hyperlink{logica_8h_a9dfbc982d23a619e36575d8e7ec8e41c}{jog}});}
\DoxyCodeLine{332     \mbox{\hyperlink{lista_8h_a9cb229685e08e4b8706349624d2091a8}{freeLista}}(L);}
\DoxyCodeLine{333 \}}
...
\DoxyCodeLine{127                                             \{}
\DoxyCodeLine{128 }
\DoxyCodeLine{129     FILE *fp;}
\DoxyCodeLine{130     \textcolor{keywordtype}{char} lin\_fich [BUF\_SIZE], *comando;}
\DoxyCodeLine{131     \textcolor{keywordtype}{int} k = 0;}
\DoxyCodeLine{132     \textcolor{keywordtype}{int} r = 0;}
\DoxyCodeLine{134     strtok(linha, \textcolor{stringliteral}{" "});}
\DoxyCodeLine{135     comando = strtok (NULL, \textcolor{stringliteral}{"\(\backslash\)n"});}
\DoxyCodeLine{137     \textcolor{comment}{//A função "access" retorna -\/1 caso nao encontre o ficheiro.}}
\DoxyCodeLine{138     \textcolor{keywordflow}{if} (access(comando, F\_OK) != -\/1) \{}
\DoxyCodeLine{139         \mbox{\hyperlink{dados_8h_a543f64d33cbc5f4c00ad7dc4e60d2105}{reinit}}(e);}
\DoxyCodeLine{140         e-\/>max\_num\_jogadas = 0;}
\DoxyCodeLine{141         fp = fopen(comando, \textcolor{stringliteral}{"r"});}
\DoxyCodeLine{142         \textcolor{keywordflow}{while} (fgets(lin\_fich, BUF\_SIZE, fp) != NULL) \{}
\DoxyCodeLine{144             \textcolor{keywordflow}{if} (k >= 9) \{}
\DoxyCodeLine{145                 \mbox{\hyperlink{dados_8h_abadfdc02ae37afa3fc371a15c0090e61}{ler\_tab}}(e, lin\_fich);}
\DoxyCodeLine{146             \}}
\DoxyCodeLine{147             k++;}
\DoxyCodeLine{148         \}}
\DoxyCodeLine{149         fclose(fp);}
\DoxyCodeLine{150         r = 1;}
\DoxyCodeLine{151     \}}
\DoxyCodeLine{152     \textcolor{keywordflow}{else}}
\DoxyCodeLine{153         r = 0;}
\DoxyCodeLine{154     \textcolor{keywordflow}{return} r;}
\DoxyCodeLine{155 \}}
...
Definido na linha 183 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{183                                  \{}
\DoxyCodeLine{184     \textcolor{keywordtype}{char} *comando, *end;}
\DoxyCodeLine{185     \textcolor{keywordtype}{int} r, max = \mbox{\hyperlink{dados_8h_a9f2d95954ffa63c2f456e9481a883071}{obter\_max\_num\_jog}}(e);}
\DoxyCodeLine{186     strtok (linha, \textcolor{stringliteral}{" "});}
\DoxyCodeLine{187     comando = strtok(NULL, \textcolor{stringliteral}{"\(\backslash\)n"});}
\DoxyCodeLine{189     r = strtol (comando, \&end, 10);}
\DoxyCodeLine{191     \textcolor{keywordflow}{if} (r < max + 1) \{}
\DoxyCodeLine{192         \mbox{\hyperlink{dados_8h_a72bd3fb56f0ac3af60c392b49f76a329}{pos\_helper}}(e, r);}
...
Definido na linha 171 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{171                                \{}
\DoxyCodeLine{172     \textcolor{keywordtype}{int} cord;}
\DoxyCodeLine{173     \textcolor{comment}{//Quando a função isalpha() retornar algum valor diferente de 0, converte-\/o num int e devolve-\/o.f}}
\DoxyCodeLine{174     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; str[i] != \textcolor{charliteral}{'\(\backslash\)0'}; i++) \{}
\DoxyCodeLine{175         \textcolor{keywordflow}{if} (isalpha(str[i]) != 0) \{}
\DoxyCodeLine{176             cord = str[i] -\/ \textcolor{charliteral}{'a'};}
\DoxyCodeLine{177             \textcolor{keywordflow}{return} cord;}
\DoxyCodeLine{178         \}}
\DoxyCodeLine{179     \}}
...
Definido na linha 157 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{157                               \{}
\DoxyCodeLine{158     \textcolor{keywordtype}{int} r = 0;}
\DoxyCodeLine{159     \textcolor{keywordtype}{char} *end;}
\DoxyCodeLine{160     \textcolor{comment}{//Quando enconrtar algum elemento da string para a qual a funcao isdigit() devolva algum valor diferente de 0, converte-\/o num int e devolve-\/o.}}
\DoxyCodeLine{161     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; str[i] != \textcolor{charliteral}{'\(\backslash\)0'}; i++) \{}
\DoxyCodeLine{162         \textcolor{keywordflow}{if} (isdigit(str[i]) != 0) \{}
\DoxyCodeLine{163            r = strtol(\&str[i], \&end, 10);}
\DoxyCodeLine{164            r = abs(r-\/8);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{111                                                 \{}
\DoxyCodeLine{112     \textcolor{keywordtype}{char} *comando;}
\DoxyCodeLine{114     strtok(linha, \textcolor{stringliteral}{" "});}
\DoxyCodeLine{115     comando = strtok(NULL, \textcolor{stringliteral}{"\(\backslash\)n"});}
\DoxyCodeLine{116 }
\DoxyCodeLine{117 }
\DoxyCodeLine{119     FILE *fp;}
\DoxyCodeLine{120     fp = fopen(comando, \textcolor{stringliteral}{"w"});}
\DoxyCodeLine{121     \mbox{\hyperlink{interface_8h_aa36b92ddb3d9b1fdb93d8524262ee66c}{imprime\_fileTab}}(e, fp);}
\DoxyCodeLine{122     \mbox{\hyperlink{interface_8h_acb7c3a1d861395fabd4db18a365738b9}{file\_posAnt}}(e, fp);}
\DoxyCodeLine{123     fclose(fp);}
\DoxyCodeLine{124 \}}
