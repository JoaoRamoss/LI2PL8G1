...
\DoxyCodeLine{104         \mbox{\hyperlink{dados_8h_a543f64d33cbc5f4c00ad7dc4e60d2105}{reinit}}(e);}
...
\DoxyCodeLine{109                 \mbox{\hyperlink{dados_8h_abadfdc02ae37afa3fc371a15c0090e61}{ler\_tab}}(e, lin\_fich);}
\DoxyCodeLine{110             \}}
\DoxyCodeLine{111             k++;}
\DoxyCodeLine{112         \}}
...
Definido na linha 147 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{147                                  \{}
\DoxyCodeLine{148     \textcolor{keywordtype}{char} *comando, *end;}
\DoxyCodeLine{149     \textcolor{keywordtype}{int} r, max = \mbox{\hyperlink{dados_8h_a6cd0b387bdee9e18003c78852394aa63}{obter\_numero\_de\_jogadas}}(e);}
\DoxyCodeLine{150     strtok (linha, \textcolor{stringliteral}{" "});}
\DoxyCodeLine{151     comando = strtok(NULL, \textcolor{stringliteral}{"\(\backslash\)n"});}
\DoxyCodeLine{153     r = strtol (comando, \&end, 10);}
\DoxyCodeLine{155     \textcolor{keywordflow}{if} (r < max + 1) \{}
\DoxyCodeLine{156         \mbox{\hyperlink{dados_8h_a72bd3fb56f0ac3af60c392b49f76a329}{pos\_helper}}(e, r);}
...
Definido na linha 135 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{135                                \{}
\DoxyCodeLine{136     \textcolor{keywordtype}{int} cord;}
\DoxyCodeLine{137     \textcolor{comment}{//Quando a função isalpha() retornar algum valor diferente de 0, converte-\/o num int e devolve-\/o.f}}
\DoxyCodeLine{138     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; str[i] != \textcolor{charliteral}{'\(\backslash\)0'}; i++) \{}
\DoxyCodeLine{139         \textcolor{keywordflow}{if} (isalpha(str[i]) != 0) \{}
\DoxyCodeLine{140             cord = str[i] -\/ \textcolor{charliteral}{'a'};}
\DoxyCodeLine{141             \textcolor{keywordflow}{return} cord;}
\DoxyCodeLine{142         \}}
\DoxyCodeLine{143     \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{121                               \{}
\DoxyCodeLine{122     \textcolor{keywordtype}{int} r = 0;}
\DoxyCodeLine{123     \textcolor{keywordtype}{char} *end;}
\DoxyCodeLine{124     \textcolor{comment}{//Quando enconrtar algum elemento da string para a qual a funcao isdigit() devolva algum valor diferente de 0, converte-\/o num int e devolve-\/o.}}
\DoxyCodeLine{125     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; str[i] != \textcolor{charliteral}{'\(\backslash\)0'}; i++) \{}
\DoxyCodeLine{126         \textcolor{keywordflow}{if} (isdigit(str[i]) != 0) \{}
\DoxyCodeLine{127            r = strtol(\&str[i], \&end, 10);}
\DoxyCodeLine{128            r = abs(r-\/8);}
\DoxyCodeLine{129            \textcolor{keywordflow}{return} r;}
\DoxyCodeLine{130         \}}
\DoxyCodeLine{131     \}}
