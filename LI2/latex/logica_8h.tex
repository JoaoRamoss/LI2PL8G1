...
\DoxyCodeLine{104         fp = fopen(comando, \textcolor{stringliteral}{"r"});}
\DoxyCodeLine{105         \textcolor{keywordflow}{while} (fgets(lin\_fich, BUF\_SIZE, fp) != NULL) \{}
\DoxyCodeLine{106             \mbox{\hyperlink{dados_8h_a99f70b4c2f315652b02f7a8c874cb2e4}{set\_casa}}(e, lin\_fich, k);}
\DoxyCodeLine{108             \textcolor{keywordflow}{if} (k >= 9) \{}
\DoxyCodeLine{109                 \mbox{\hyperlink{logica_8h_a608d40c8b37424e7bd4e5ee3f0fe8b97}{update\_array\_jogadas}}(e, lin\_fich);}
\DoxyCodeLine{110             \}}
\DoxyCodeLine{111             k++;}
\DoxyCodeLine{112         \}}
\DoxyCodeLine{113         fclose(fp);}
\DoxyCodeLine{114         r = 1;}
\DoxyCodeLine{115     \}}
\DoxyCodeLine{116     \textcolor{keywordflow}{else}}
\DoxyCodeLine{117         r = 0;}
\DoxyCodeLine{118     \textcolor{keywordflow}{return} r;}
\DoxyCodeLine{119 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{155                                \{}
\DoxyCodeLine{156     \textcolor{keywordtype}{int} cord;}
\DoxyCodeLine{157     \textcolor{comment}{//Quando a função isalpha() retornar algum valor diferente de 0, converte-\/o num int e devolve-\/o.f}}
\DoxyCodeLine{158     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; str[i] != \textcolor{charliteral}{'\(\backslash\)0'}; i++) \{}
\DoxyCodeLine{159         \textcolor{keywordflow}{if} (isalpha(str[i]) != 0) \{}
\DoxyCodeLine{160             cord = str[i] -\/ \textcolor{charliteral}{'a'};}
\DoxyCodeLine{161             \textcolor{keywordflow}{return} cord;}
\DoxyCodeLine{162         \}}
\DoxyCodeLine{163     \}}
...
\DoxyCodeLine{143     \textcolor{keywordtype}{char} *end;}
\DoxyCodeLine{144     \textcolor{comment}{//Quando enconrtar algum elemento da string para a qual a funcao isdigit() devolva algum valor diferente de 0, converte-\/o num int e devolve-\/o.}}
\DoxyCodeLine{145     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; str[i] != \textcolor{charliteral}{'\(\backslash\)0'}; i++) \{}
\DoxyCodeLine{146         \textcolor{keywordflow}{if} (isdigit(str[i]) != 0) \{}
\DoxyCodeLine{147            r = strtol(\&str[i], \&end, 10);}
\DoxyCodeLine{148            r = abs(r-\/8);}
...
Definido na linha 121 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{121                                                        \{}
\DoxyCodeLine{122     \textcolor{keywordtype}{int} i, index;}
\DoxyCodeLine{123     \textcolor{keywordtype}{char} *nome;}
\DoxyCodeLine{124     \textcolor{comment}{// A partir do ficheiro, obtem o numero da jogada e guarda-\/a na variável index.}}
\DoxyCodeLine{125     index = atoi(lin\_fich) -\/ 1;}
\DoxyCodeLine{126 }
\DoxyCodeLine{127     \textcolor{comment}{/* Retira os primeiros 4 elementos da string (uma string que fosse: "01: e5 d5" passa a ser "e5 d5".}}
\DoxyCodeLine{128 \textcolor{comment}{     */}}
\DoxyCodeLine{129     strtok(lin\_fich, \textcolor{stringliteral}{" "});}
\DoxyCodeLine{130     nome = strtok(NULL, \textcolor{stringliteral}{"\(\backslash\)n"});}
\DoxyCodeLine{132     \textcolor{keywordflow}{for} (i = 0; nome[i] != \textcolor{charliteral}{'\(\backslash\)0'} ; i++);}
\DoxyCodeLine{133     \textcolor{keywordflow}{if} (i > 2)}
\DoxyCodeLine{134         \mbox{\hyperlink{dados_8h_afc541510798bc33e8220baa9bf271f46}{set\_jogadas}}(e, nome, 2, index);}
\DoxyCodeLine{135 }
\DoxyCodeLine{136     \textcolor{keywordflow}{else}}
\DoxyCodeLine{137         \mbox{\hyperlink{dados_8h_afc541510798bc33e8220baa9bf271f46}{set\_jogadas}}(e, nome, 1, index);}
\DoxyCodeLine{138 \}}
