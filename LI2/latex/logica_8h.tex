...
int \mbox{\hyperlink{logica_8h_aa375942115b84ed0b58b86ea76a82084}{minimax}} (\mbox{\hyperlink{struct_e_s_t_a_d_o}{E\+S\+T\+A\+DO}} $\ast$e, int depth, int player)
...
Definido na linha 300 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{300                           \{}
\DoxyCodeLine{301     \textcolor{keywordtype}{int} bestScore = INT\_MIN, score, atual = \mbox{\hyperlink{dados_8h_ad6e326e4ffa57ca1ae0c75377ecefc8c}{obter\_jogador\_atual}}(e);}
\DoxyCodeLine{302     \mbox{\hyperlink{struct_c_o_o_r_d_e_n_a_d_a}{COORDENADA}} best\_jogada;}
\DoxyCodeLine{303     \mbox{\hyperlink{structnodo}{LISTA}} L =  \mbox{\hyperlink{lista_8h_ae3b99323b6f8f35d80bb69ff1a27985e}{criar\_lista}}();}
\DoxyCodeLine{304     L = \mbox{\hyperlink{lista_8h_a0b56764e73eb24ca541210236e5ee307}{add\_livres}}(e, L);}
\DoxyCodeLine{306     \textcolor{keywordflow}{if} (\mbox{\hyperlink{logica_8h_a0d0ae42af34190215d0219bc3230873b}{check\_vencedora}}(e, L) != 1) \{}
\DoxyCodeLine{307         \textcolor{keywordflow}{while} (\mbox{\hyperlink{lista_8h_a4c10928f7acaa4e3de3760cea0dfd9c0}{lista\_esta\_vazia}}(L) != 1) \{}
\DoxyCodeLine{308             \textcolor{keywordtype}{char} *str = (\textcolor{keywordtype}{char} *) \mbox{\hyperlink{lista_8h_abfcb205f3eb670157be0d1221021714b}{devolve\_cabeca}}(L);}
\DoxyCodeLine{309             \textcolor{keywordflow}{if} (strncmp(str, \textcolor{stringliteral}{"7 0"}, 3) != 0) \{}
\DoxyCodeLine{310                 \mbox{\hyperlink{struct_e_s_t_a_d_o}{ESTADO}} *aux = \mbox{\hyperlink{dados_8h_a7e0c7e26fb685d9ab501e19b05e6954f}{inicializar\_estado}}();}
\DoxyCodeLine{311                 \mbox{\hyperlink{logica_8h_a3815d005d1762c547d70d3198048e7d3}{copyStruct}}(e, aux);}
\DoxyCodeLine{312                 \mbox{\hyperlink{struct_c_o_o_r_d_e_n_a_d_a}{COORDENADA}} \mbox{\hyperlink{logica_8h_a9dfbc982d23a619e36575d8e7ec8e41c}{jog}} = \mbox{\hyperlink{logica_8h_a33c8928e31992541dd9cf0ce0e9f7d50}{get\_cords}}(str);}
\DoxyCodeLine{313                 \mbox{\hyperlink{logica_8h_ac313d7e553b1e2b5f266acb9bfff8141}{jogar}}(aux, \mbox{\hyperlink{logica_8h_a9dfbc982d23a619e36575d8e7ec8e41c}{jog}});}
\DoxyCodeLine{314                 \textcolor{keywordflow}{if} (atual == 1)}
\DoxyCodeLine{315                     score = \mbox{\hyperlink{logica_8h_aa375942115b84ed0b58b86ea76a82084}{minimax}}(aux, 5, 1);}
\DoxyCodeLine{316                 \textcolor{keywordflow}{else}}
\DoxyCodeLine{317                     score = \mbox{\hyperlink{logica_8h_aa375942115b84ed0b58b86ea76a82084}{minimax}}(aux, 5, -\/1);}
\DoxyCodeLine{318                 free(aux);}
\DoxyCodeLine{319                 \textcolor{keywordflow}{if} (score > bestScore) \{}
\DoxyCodeLine{320                     bestScore = score;}
\DoxyCodeLine{321                     best\_jogada = \mbox{\hyperlink{logica_8h_a9dfbc982d23a619e36575d8e7ec8e41c}{jog}};}
\DoxyCodeLine{322                 \}}
\DoxyCodeLine{323             \}}
\DoxyCodeLine{324             L = \mbox{\hyperlink{lista_8h_a9026a681a68322b5ec7f07137b864cbd}{remove\_cabeca}}(L);}
\DoxyCodeLine{325         \}}
\DoxyCodeLine{326     \}}
\DoxyCodeLine{327     \textcolor{keywordflow}{else}}
\DoxyCodeLine{328         best\_jogada = \mbox{\hyperlink{logica_8h_a269576c01f83872ee667e982ab409612}{get\_vencedor}}(L);}
\DoxyCodeLine{329 }
\DoxyCodeLine{330     printf(\textcolor{stringliteral}{"\(\backslash\)nbestscore: \%d\(\backslash\)n"}, bestScore);}
\DoxyCodeLine{331     \mbox{\hyperlink{logica_8h_ac313d7e553b1e2b5f266acb9bfff8141}{jogar}}(e, best\_jogada);}
\DoxyCodeLine{332 \}}
...
Definido na linha 361 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{361                                          \{}
\DoxyCodeLine{362     \mbox{\hyperlink{structnodo}{LISTA}} T;}
\DoxyCodeLine{363     \textcolor{keywordtype}{int} atual = \mbox{\hyperlink{dados_8h_ad6e326e4ffa57ca1ae0c75377ecefc8c}{obter\_jogador\_atual}}(e);}
\DoxyCodeLine{364     \textcolor{keywordflow}{for} (T = L; !\mbox{\hyperlink{lista_8h_a4c10928f7acaa4e3de3760cea0dfd9c0}{lista\_esta\_vazia}}(T); T = \mbox{\hyperlink{lista_8h_ad9380152361127432c55c1c6067e05ae}{proximo}}(T)) \{}
\DoxyCodeLine{365         \textcolor{keywordtype}{char} *str = (\textcolor{keywordtype}{char} *) \mbox{\hyperlink{lista_8h_abfcb205f3eb670157be0d1221021714b}{devolve\_cabeca}}(T);}
\DoxyCodeLine{366         \textcolor{keywordflow}{if} (strncmp (str,\textcolor{stringliteral}{"7 0"}, 3) == 0 \&\& atual == 1)}
...
Definido na linha 266 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{266                                          \{}
\DoxyCodeLine{267     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < 8; i++) \{}
\DoxyCodeLine{268         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 0; j < 8; j++) \{}
\DoxyCodeLine{269             aux-\/>tab[i][j] = e-\/>tab[i][j];}
\DoxyCodeLine{270         \}}
\DoxyCodeLine{271     \}}
\DoxyCodeLine{272     aux-\/>ultima\_jogada = e-\/>ultima\_jogada;}
\DoxyCodeLine{273     aux-\/>jogador\_atual = e-\/>jogador\_atual;}
\DoxyCodeLine{274     aux-\/>num\_jogadas = e-\/>num\_jogadas;}
\DoxyCodeLine{275 \}}
...
Definido na linha 237 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{237                                 \{}
\DoxyCodeLine{238     \textcolor{keywordtype}{char} *end;}
\DoxyCodeLine{239     \textcolor{keywordtype}{int} col, lin;}
\DoxyCodeLine{240     lin = strtol(str, \&end,  10);}
\DoxyCodeLine{241     col = strtol(end,  \&end,10);}
\DoxyCodeLine{242     \mbox{\hyperlink{struct_c_o_o_r_d_e_n_a_d_a}{COORDENADA}} cord = \{col, abs(lin-\/8)-\/1\};}
\DoxyCodeLine{243     \textcolor{keywordflow}{return} cord;}
\DoxyCodeLine{244 \}}
...
Definido na linha 372 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{372                                  \{}
\DoxyCodeLine{373     \mbox{\hyperlink{struct_c_o_o_r_d_e_n_a_d_a}{COORDENADA}} jogada;}
\DoxyCodeLine{374     \textcolor{keywordflow}{while} (\mbox{\hyperlink{lista_8h_a4c10928f7acaa4e3de3760cea0dfd9c0}{lista\_esta\_vazia}}(L) != 1) \{}
\DoxyCodeLine{375         \textcolor{keywordtype}{char} *str = (\textcolor{keywordtype}{char} *) \mbox{\hyperlink{lista_8h_abfcb205f3eb670157be0d1221021714b}{devolve\_cabeca}}(L);}
\DoxyCodeLine{376         \textcolor{keywordflow}{if} (strncmp(str, \textcolor{stringliteral}{"7 0"}, 3) == 0) \{}
\DoxyCodeLine{377             jogada = \mbox{\hyperlink{logica_8h_a33c8928e31992541dd9cf0ce0e9f7d50}{get\_cords}}(str);}
\DoxyCodeLine{378             \textcolor{keywordflow}{break};}
\DoxyCodeLine{379         \}}
\DoxyCodeLine{380         L = \mbox{\hyperlink{lista_8h_a9026a681a68322b5ec7f07137b864cbd}{remove\_cabeca}}(L);}
\DoxyCodeLine{381     \}}
\DoxyCodeLine{382     \textcolor{keywordflow}{return} jogada;}
\DoxyCodeLine{383 \}}
...
Definido na linha 278 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{278                      \{}
\DoxyCodeLine{280     \mbox{\hyperlink{structnodo}{LISTA}} L = \mbox{\hyperlink{lista_8h_ae3b99323b6f8f35d80bb69ff1a27985e}{criar\_lista}}();}
\DoxyCodeLine{281     L = \mbox{\hyperlink{lista_8h_a0b56764e73eb24ca541210236e5ee307}{add\_livres}}(e, L);}
\DoxyCodeLine{282     \textcolor{keywordflow}{for}(\mbox{\hyperlink{structnodo}{LISTA}} K = L; \mbox{\hyperlink{lista_8h_a4c10928f7acaa4e3de3760cea0dfd9c0}{lista\_esta\_vazia}}(K) != 1; K = \mbox{\hyperlink{lista_8h_ad9380152361127432c55c1c6067e05ae}{proximo}}(K)) \{}
\DoxyCodeLine{283         \textcolor{keywordtype}{char} *str = (\textcolor{keywordtype}{char}*)\mbox{\hyperlink{lista_8h_abfcb205f3eb670157be0d1221021714b}{devolve\_cabeca}}(K);}
\DoxyCodeLine{284         printf(\textcolor{stringliteral}{"\%s\(\backslash\)n"}, str);}
\DoxyCodeLine{285     \}}
\DoxyCodeLine{286     \mbox{\hyperlink{structnodo}{LISTA}} T = L;}
\DoxyCodeLine{288     \textcolor{keywordtype}{int} length = \mbox{\hyperlink{lista_8h_afbf1fd7cbee0a00eef9742a686e60c93}{lengthLista}}(L);}
\DoxyCodeLine{289     \textcolor{keywordtype}{int} random = rand() \% length;}
\DoxyCodeLine{290     \textcolor{keywordtype}{char} *str;}
\DoxyCodeLine{292     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < random; i++)}
\DoxyCodeLine{293         T = \mbox{\hyperlink{lista_8h_ad9380152361127432c55c1c6067e05ae}{proximo}}(T);}
\DoxyCodeLine{294     str = (\textcolor{keywordtype}{char}*) \mbox{\hyperlink{lista_8h_abfcb205f3eb670157be0d1221021714b}{devolve\_cabeca}}(T);}
\DoxyCodeLine{295     \mbox{\hyperlink{struct_c_o_o_r_d_e_n_a_d_a}{COORDENADA}} \mbox{\hyperlink{logica_8h_a9dfbc982d23a619e36575d8e7ec8e41c}{jog}} = \mbox{\hyperlink{logica_8h_a33c8928e31992541dd9cf0ce0e9f7d50}{get\_cords}}(str);}
\DoxyCodeLine{296     \mbox{\hyperlink{logica_8h_ac313d7e553b1e2b5f266acb9bfff8141}{jogar}}(e, \mbox{\hyperlink{logica_8h_a9dfbc982d23a619e36575d8e7ec8e41c}{jog}});}
\DoxyCodeLine{297     \mbox{\hyperlink{lista_8h_a9cb229685e08e4b8706349624d2091a8}{freeLista}}(L);}
\DoxyCodeLine{298 \}}
...
\end{DoxyCode}
\mbox{\Hypertarget{logica_8h_aa375942115b84ed0b58b86ea76a82084}\label{logica_8h_aa375942115b84ed0b58b86ea76a82084}} 
...
{\footnotesize\ttfamily int minimax (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{struct_e_s_t_a_d_o}{E\+S\+T\+A\+DO}} $\ast$}]{e,  }\item[{int}]{depth,  }\item[{int}]{player }\end{DoxyParamCaption})}
...
Definido na linha 334 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{334                                                \{}
\DoxyCodeLine{335     \textcolor{keywordtype}{int} bestScore = INT\_MIN, score;}
\DoxyCodeLine{336     \mbox{\hyperlink{structnodo}{LISTA}} L = \mbox{\hyperlink{lista_8h_ae3b99323b6f8f35d80bb69ff1a27985e}{criar\_lista}}();}
\DoxyCodeLine{337     L = \mbox{\hyperlink{lista_8h_a0b56764e73eb24ca541210236e5ee307}{add\_livres}}(e, L);}
\DoxyCodeLine{339     \textcolor{keywordflow}{if} (depth == 0 || \mbox{\hyperlink{logica_8h_aea1fcb269536a2b7ee0d12518887cd09}{jogo\_terminado}}(e)) \{}
\DoxyCodeLine{340         \textcolor{keywordflow}{return} (\mbox{\hyperlink{logica_8h_a2b0f98e3493bc14d0f07d5ba5790c3bb}{scores}}(e)*player);}
\DoxyCodeLine{341     \}}
\DoxyCodeLine{343     \textcolor{keywordflow}{while} (\mbox{\hyperlink{lista_8h_a4c10928f7acaa4e3de3760cea0dfd9c0}{lista\_esta\_vazia}}(L) != 1) \{}
\DoxyCodeLine{344         \mbox{\hyperlink{struct_e_s_t_a_d_o}{ESTADO}} *aux = \mbox{\hyperlink{dados_8h_a7e0c7e26fb685d9ab501e19b05e6954f}{inicializar\_estado}}();}
\DoxyCodeLine{345         \mbox{\hyperlink{logica_8h_a3815d005d1762c547d70d3198048e7d3}{copyStruct}}(e, aux);}
\DoxyCodeLine{346         \textcolor{keywordtype}{char} *str = (\textcolor{keywordtype}{char} *) \mbox{\hyperlink{lista_8h_abfcb205f3eb670157be0d1221021714b}{devolve\_cabeca}}(L);}
\DoxyCodeLine{347         \mbox{\hyperlink{struct_c_o_o_r_d_e_n_a_d_a}{COORDENADA}} jogada = \mbox{\hyperlink{logica_8h_a33c8928e31992541dd9cf0ce0e9f7d50}{get\_cords}}(str);}
\DoxyCodeLine{348         \textcolor{keywordflow}{if} (strncmp(str, \textcolor{stringliteral}{"0 7"}, 3) == 0 || strncmp (str, \textcolor{stringliteral}{"7 0"}, 3) == 0)}
\DoxyCodeLine{349             \textcolor{keywordflow}{return} (\mbox{\hyperlink{logica_8h_a2b0f98e3493bc14d0f07d5ba5790c3bb}{scores}}(e)*(player));}
\DoxyCodeLine{350 }
\DoxyCodeLine{351         \mbox{\hyperlink{logica_8h_ac313d7e553b1e2b5f266acb9bfff8141}{jogar}}(aux, jogada);}
\DoxyCodeLine{352         score = -\/\mbox{\hyperlink{logica_8h_aa375942115b84ed0b58b86ea76a82084}{minimax}}(aux, depth -\/ 1, player * (-\/1));}
\DoxyCodeLine{353         free(aux);}
\DoxyCodeLine{354         \textcolor{keywordflow}{if} (score > bestScore)}
\DoxyCodeLine{355             bestScore = score;}
\DoxyCodeLine{356         L = \mbox{\hyperlink{lista_8h_a9026a681a68322b5ec7f07137b864cbd}{remove\_cabeca}}(L);}
\DoxyCodeLine{357     \}}
\DoxyCodeLine{358     \textcolor{keywordflow}{return} bestScore;}
\DoxyCodeLine{359 \}}
...
Definido na linha 247 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{247                       \{}
\DoxyCodeLine{250     \textcolor{keywordtype}{int} tabela[8][8], score = 0;}
\DoxyCodeLine{251     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < 8; i++) \{}
\DoxyCodeLine{252         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 0; j < 8; j++) \{}
\DoxyCodeLine{253             tabela[i][j] = i-\/j;}
\DoxyCodeLine{254         \}}
\DoxyCodeLine{255     \}}
\DoxyCodeLine{257     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < 8; i++) \{}
\DoxyCodeLine{258         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 0; j < 8; j++) \{}
\DoxyCodeLine{259             \textcolor{keywordflow}{if} (\mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, i, j) == BRANCA)}
\DoxyCodeLine{260                 score = tabela[i][j];}
\DoxyCodeLine{261         \}}
\DoxyCodeLine{262     \}}
\DoxyCodeLine{263     \textcolor{keywordflow}{return} score;}
\DoxyCodeLine{264 \}}
