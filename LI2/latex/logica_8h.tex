...
\begin{DoxyCode}{0}
\DoxyCodeLine{99                              \{}
\DoxyCodeLine{100     \textcolor{keywordtype}{int} col = e-\/>ultima\_jogada.coluna, lin = e-\/>ultima\_jogada.linha;}
\DoxyCodeLine{101     \textcolor{keywordflow}{if} (\mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin, col + 1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin+1, col+1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin+1, col) == PRETA \&\&}
\DoxyCodeLine{102     \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin, col-\/1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin-\/1, col-\/1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin-\/1, col) == PRETA)}
...
Definido na linha 81 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{81                            \{}
\DoxyCodeLine{82     \textcolor{keywordtype}{int} col = e-\/>ultima\_jogada.coluna, lin = e-\/>ultima\_jogada.linha;}
\DoxyCodeLine{84     \textcolor{keywordflow}{if} (col == 0 \&\& lin == 0) \{}
...
\DoxyCodeLine{87     \}}
\DoxyCodeLine{88     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (col == 7 \&\& lin == 7) \{}
\DoxyCodeLine{89         \textcolor{keywordflow}{if} (\mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin, col-\/1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin-\/1, col-\/1) == PRETA \&\& \mbox{\hyperlink{dados_8h_ad4e371755c518dbe632dc8cb1280cdad}{obter\_casa}}(e, lin-\/1, col) == PRETA)}
\DoxyCodeLine{90             \textcolor{keywordflow}{return} 1;}
\DoxyCodeLine{91     \}}
\DoxyCodeLine{93     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (\mbox{\hyperlink{logica_8h_a9065d2c25c9052ce1f7f5e1d6272dd6e}{check\_around}}(e) == 1)}
...
\DoxyCodeLine{73                 r = 3;}
\DoxyCodeLine{74     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (\mbox{\hyperlink{logica_8h_a1e08ddaa296db25866c21b3ea2a9c106}{encurralado}}(e) == 1)}
\DoxyCodeLine{75         r = 4;}
\DoxyCodeLine{76     \textcolor{keywordflow}{else}}
\DoxyCodeLine{77         r = 0;}
\DoxyCodeLine{78     \textcolor{keywordflow}{return} r;}
\DoxyCodeLine{79 \}}
...
Definido na linha 125 do ficheiro logica.\+c.
...
\DoxyCodeLine{128     \textcolor{keywordtype}{char} lin\_fich [BUF\_SIZE], *comando;}
\DoxyCodeLine{129     \textcolor{keywordtype}{int} k = 0;}
\DoxyCodeLine{130     \textcolor{keywordtype}{int} r = 0;}
\DoxyCodeLine{132     strtok(linha, \textcolor{stringliteral}{" "});}
\DoxyCodeLine{133     comando = strtok (NULL, \textcolor{stringliteral}{"\(\backslash\)n"});}
\DoxyCodeLine{135     \textcolor{comment}{//A função "access" retorna -\/1 caso nao encontre o ficheiro.}}
\DoxyCodeLine{136     \textcolor{keywordflow}{if} (access(comando, F\_OK) != -\/1) \{}
\DoxyCodeLine{137         \mbox{\hyperlink{dados_8h_a543f64d33cbc5f4c00ad7dc4e60d2105}{reinit}}(e);}
\DoxyCodeLine{138         e-\/>max\_num\_jogadas = 0;}
\DoxyCodeLine{139         fp = fopen(comando, \textcolor{stringliteral}{"r"});}
\DoxyCodeLine{140         \textcolor{keywordflow}{while} (fgets(lin\_fich, BUF\_SIZE, fp) != NULL) \{}
\DoxyCodeLine{142             \textcolor{keywordflow}{if} (k >= 9) \{}
\DoxyCodeLine{143                 \mbox{\hyperlink{dados_8h_abadfdc02ae37afa3fc371a15c0090e61}{ler\_tab}}(e, lin\_fich);}
\DoxyCodeLine{144             \}}
\DoxyCodeLine{145             k++;}
\DoxyCodeLine{146         \}}
\DoxyCodeLine{147         fclose(fp);}
\DoxyCodeLine{148         r = 1;}
\DoxyCodeLine{149     \}}
\DoxyCodeLine{150     \textcolor{keywordflow}{else}}
\DoxyCodeLine{151         r = 0;}
\DoxyCodeLine{152     \textcolor{keywordflow}{return} r;}
\DoxyCodeLine{153 \}}
...
Definido na linha 181 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{181                                  \{}
\DoxyCodeLine{182     \textcolor{keywordtype}{char} *comando, *end;}
\DoxyCodeLine{183     \textcolor{keywordtype}{int} r, max = \mbox{\hyperlink{dados_8h_a9f2d95954ffa63c2f456e9481a883071}{obter\_max\_num\_jog}}(e);}
\DoxyCodeLine{184     strtok (linha, \textcolor{stringliteral}{" "});}
\DoxyCodeLine{185     comando = strtok(NULL, \textcolor{stringliteral}{"\(\backslash\)n"});}
\DoxyCodeLine{187     r = strtol (comando, \&end, 10);}
\DoxyCodeLine{189     \textcolor{keywordflow}{if} (r < max + 1) \{}
\DoxyCodeLine{190         \mbox{\hyperlink{dados_8h_a72bd3fb56f0ac3af60c392b49f76a329}{pos\_helper}}(e, r);}
...
Definido na linha 169 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{169                                \{}
\DoxyCodeLine{170     \textcolor{keywordtype}{int} cord;}
\DoxyCodeLine{171     \textcolor{comment}{//Quando a função isalpha() retornar algum valor diferente de 0, converte-\/o num int e devolve-\/o.f}}
\DoxyCodeLine{172     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; str[i] != \textcolor{charliteral}{'\(\backslash\)0'}; i++) \{}
\DoxyCodeLine{173         \textcolor{keywordflow}{if} (isalpha(str[i]) != 0) \{}
\DoxyCodeLine{174             cord = str[i] -\/ \textcolor{charliteral}{'a'};}
\DoxyCodeLine{175             \textcolor{keywordflow}{return} cord;}
\DoxyCodeLine{176         \}}
\DoxyCodeLine{177     \}}
...
Definido na linha 155 do ficheiro logica.\+c.


\begin{DoxyCode}{0}
\DoxyCodeLine{155                               \{}
\DoxyCodeLine{156     \textcolor{keywordtype}{int} r = 0;}
\DoxyCodeLine{157     \textcolor{keywordtype}{char} *end;}
\DoxyCodeLine{158     \textcolor{comment}{//Quando enconrtar algum elemento da string para a qual a funcao isdigit() devolva algum valor diferente de 0, converte-\/o num int e devolve-\/o.}}
\DoxyCodeLine{159     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; str[i] != \textcolor{charliteral}{'\(\backslash\)0'}; i++) \{}
\DoxyCodeLine{160         \textcolor{keywordflow}{if} (isdigit(str[i]) != 0) \{}
\DoxyCodeLine{161            r = strtol(\&str[i], \&end, 10);}
\DoxyCodeLine{162            r = abs(r-\/8);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{109                                                 \{}
\DoxyCodeLine{110     \textcolor{keywordtype}{char} *comando;}
\DoxyCodeLine{112     strtok(linha, \textcolor{stringliteral}{" "});}
\DoxyCodeLine{113     comando = strtok(NULL, \textcolor{stringliteral}{"\(\backslash\)n"});}
\DoxyCodeLine{114 }
\DoxyCodeLine{115 }
\DoxyCodeLine{117     FILE *fp;}
\DoxyCodeLine{118     fp = fopen(comando, \textcolor{stringliteral}{"w"});}
\DoxyCodeLine{119     \mbox{\hyperlink{interface_8h_aa36b92ddb3d9b1fdb93d8524262ee66c}{imprime\_fileTab}}(e, fp);}
\DoxyCodeLine{120     \mbox{\hyperlink{interface_8h_acb7c3a1d861395fabd4db18a365738b9}{file\_posAnt}}(e, fp);}
\DoxyCodeLine{121     fclose(fp);}
\DoxyCodeLine{122 \}}
